...
export default function Analytics() {
  ...
  const PIE_COLORS = ['#09090b', '#71717a', '#a1a1aa'];
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-zinc-950 m-0">Traffic Intelligence & Analytics</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="pro-card p-4 rounded-xl">
          <span className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Compliance Rate</span>
          <p className="text-2xl font-bold font-mono text-emerald-700 mt-1">{summary.helmet_compliance_rate || 100}%</p>
          <span className="text-[11px] text-zinc-500">Riders with helmets</span>
        </div>

        <div className="pro-card p-4 rounded-xl">
          <span className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Electric Vehicles</span>
          <p className="text-2xl font-bold font-mono text-zinc-950 mt-1">{summary.evs || 0}</p>
        ...
        <div className="pro-card p-4 rounded-xl">
          ...
          <p className="text-2xl font-bold font-mono text-rose-700 mt-1">{summary.total_violations || 0}</p>
          <span className="text-[11px] text-zinc-500">Recorded infractions</span>
        </div>

        <div className="pro-card p-4 rounded-xl">
          <span className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Missing Plates</span>
          <p className="text-2xl font-bold font-mono text-zinc-950 mt-1">{summary.missing_plate_violations || 0}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="pro-card rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-sm text-zinc-950">Traffic Density Distribution</h3>
              <p className="text-xs text-zinc-500">Detections grouped across 24h timeline</p>
            </div>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={hourly} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                />
                <Area type="monotone" dataKey="count" stroke="#18181b" strokeWidth={2} fill="url(#areaColor)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="pro-card rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-sm text-zinc-950">Infractions by Category</h3>
              <p className="text-xs text-zinc-500">Breakdown of road safety violations detected</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="pro-card rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-sm text-zinc-950">Propulsion Distribution</h3>
              <p className="text-xs text-zinc-500">Electric vehicles verified vs conventional fossil fuel</p>
            </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: '#09090b', borderColor: '#27272a', borderRadius: '8px', color: '#fff', fontSize: '12px' }}
                />
                <Legend verticalAlign="bottom" height={36} wrapperStyle={{ fontSize: '11px', color: '#52525b' }} />
              </PieChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="pro-card rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-sm text-zinc-950">Vehicles by Classification</h3>
              <p className="text-xs text-zinc-500">Total volume grouped by vehicle body class</p>
            </div>
