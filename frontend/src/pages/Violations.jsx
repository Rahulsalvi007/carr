          ...
          <div className="bg-white border border-zinc-200 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm text-zinc-950">Delete Violation Record</h3>
                  <p className="text-xs text-zinc-500 font-mono">
                    #{deletingRecord.id} • {deletingRecord.violation_type.replace(/_/g, ' ')}
                  </p>
                </div>
              </div>

              <p className="text-xs text-zinc-600 leading-relaxed">
                Are you sure you want to permanently delete this infraction evidence and audit record? This action cannot be undone.
              </p>
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm text-zinc-950">Delete Selected Violations</h3>
                  <p className="text-xs text-zinc-500">{selectedIds.length} records selected</p>
                </div>
              </div>

              <p className="text-xs text-zinc-600 leading-relaxed">
                Are you sure you want to delete these <strong className="text-zinc-950">{selectedIds.length}</strong> selected violations? This bulk operation is permanent.
              </p>
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                >
                  <Trash2 size={13} />
                  <span>{isBulkDeleting ? 'Deleting...' : `Delete ${selectedIds.length} Violations`}</span>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm text-zinc-950">Clear Violations History</h3>
                  <p className="text-xs text-zinc-500">Database Purge Action</p>
                </div>
              </div>

              <p className="text-xs text-zinc-600 leading-relaxed">
                {filterType !== 'ALL' ? (
                  <>Are you sure you want to permanently clear all <strong className="text-zinc-950">{filterType.replace(/_/g, ' ')}</strong> records?</>
                ) : (
                  <>Are you sure you want to permanently clear the <strong className="text-zinc-950">entire violations history</strong>? All recorded infractions will be erased.</>
                )}
              </p>
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                >
                  <Trash2 size={13} />
                  <span>{isClearingAll ? 'Clearing...' : 'Yes, Purge Violations'}</span>
                </button>
              </div>
            </div>
          </div>
