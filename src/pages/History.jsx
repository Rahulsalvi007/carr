  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 relative pb-12">
      ...
      <ConfirmModal
        ...
        subtitle={deletingRecord ? `Record #${deletingRecord.id} • ${deletingRecord.vehicle_type}` : ''}
        description="Are you sure you want to permanently delete this detection log? This action cannot be undone."
      ...
      <ConfirmModal
        ...
        description={`Are you sure you want to delete these ${selectedIds.length} selected records? This bulk operation is irreversible.`}
      ...
      <ConfirmModal
        ...
        subtitle="Database Purge Operation"
        description={
          filterVehicle !== 'ALL'
            ? `Are you sure you want to delete all ${filterVehicle} detection records from the system?`
            : "Are you sure you want to permanently clear the entire detection history? All logs and audit notes will be permanently removed."
        }
        confirmText="Yes, Purge History"
        confirmVariant="danger"
